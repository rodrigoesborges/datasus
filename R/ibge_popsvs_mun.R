...
#'
#' @usage ibge_popsvs_mun(linha = "Município", coluna = "Não ativa",
...
#' ibge_popsvs_mun(municipio = 500270)
#' }
#'
...
ibge_popsvs_mun <- function(linha = "Munic\u00edpio", coluna = "Faixa Et\u00e1ria 2", conteudo = 1, periodo = "last", regiao = "all",
